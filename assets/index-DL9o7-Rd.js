...
#define LOW_PRECISION`),e}function Pd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===io?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Jo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qt&&(e="SHADOWMAP_TYPE_VSM"),e}function Ld(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Qn:case ei:e="ENVMAP_TYPE_CUBE";break;case ar:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Dd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ei:e="ENVMAP_MODE_REFRACTION";break}return e}function Ud(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Us:e="ENVMAP_BLENDING_MULTIPLY";break;case gl:e="ENVMAP_BLENDING_MIX";break;case vl:e="ENVMAP_BLENDING_ADD";break}return e}function Id(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Nd(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Pd(t),c=Ld(t),u=Dd(t),d=Ud(t),p=Id(t),m=Ed(t),v=yd(s),S=r.createProgram();let f,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`,Qi={texture1:{type:"t",value:new Mp().load(Ap)},time:{type:"f",value:ur.getElapsedTime()}},Go=new qs(500,60,40);Go.scale(-1,1,1);const Pp=new jt({uniforms:Qi,vertexShader:Rp,fragmentShader:Cp});Ks=new wt(Go,Pp);Ks.rotation.set(0,-90,0);const Lp=new Pn,Dp=new _p({color:53248}),hr=new wt(Lp,Dp);hr.position.set(5,-5,-5);hr.scale.set(2,2,2);un.add(hr);const Up=new Pn(100,100,100,4,4,4),Ip=new ks({color:16711935,wireframe:!0}),Np=new wt(Up,Ip),Fp=document.getElementById("canvas");Fp.remove();Bp();function Op(i){ur.start(),gi=new At(85,window.innerWidth/window.innerHeight,1,1100),Fo=new rr(gi),Kn=new pp({antialias:!0}),Kn.setPixelRatio(window.devicePixelRatio),Kn.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(Kn.domElement),Vo(),un.add(Ks),un.add(Np)}function Bp(){const i=new to;i.position.set(1,1,1),un.add(i);const e=new to;e.position.set(-1,-1,-.5),un.add(e);const t=new yp;t.intensity=.1,un.add(t)}function Vo(){window.requestAnimationFrame(Vo),Fo.update(),Kn.render(un,gi),hr.rotation.y+=.0025;var i=zo-Oo,e=Ho-Bo;bp.innerHTML="lat: "+i+" long: "+e,Qi.time.value<1?Qi.time.value=ur.getElapsedTime():Qi.time.value=1}function ko(){}function zp(i){console.log(i),zo=i.coords.latitude,Ho=i.coords.longitude}navigator.geolocation.watchPosition(zp,ko,{enableHighAccuracy:!0});function Hp(i){Oo=i.coords.latitude,Bo=i.coords.longitude}navigator.geolocation.getCurrentPosition(Hp,ko,{enableHighAccuracy:!0});window.addEventListener("resize",()=>{gi.aspect=window.innerWidth/window.innerHeight,gi.updateProjectionMatrix(),Kn.setSize(window.innerWidth,window.innerHeight)});
