...
`)}function Ed(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ui(i){return i!==""}function Ya(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ka(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const yd=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ls(i){return i.replace(yd,Ad)}const Td=new Map;function Ad(i,e){let t=Ce[e];if(t===void 0){const n=Td.get(e);if(n!==void 0)t=Ce[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ls(t)}const bd=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Za(i){return i.replace(bd,wd)}function wd(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function $a(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Rd(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ao?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===$o?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qt&&(e="SHADOWMAP_TYPE_VSM"),e}function Cd(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Jn:case Qn:e="ENVMAP_TYPE_CUBE";break;case ar:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Pd(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Qn:e="ENVMAP_MODE_REFRACTION";break}return e}function Ld(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Fs:e="ENVMAP_BLENDING_MULTIPLY";break;case ml:e="ENVMAP_BLENDING_MIX";break;case _l:e="ENVMAP_BLENDING_ADD";break}return e}function Dd(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Ud(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Rd(t),c=Cd(t),u=Pd(t),d=Ld(t),p=Dd(t),m=Md(t),v=Sd(s),S=r.createProgram();let f,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(ui).join(`
`)),o=Ls(o),o=Ya(o,t),o=Ka(o,t),a=Ls(a),a=Ya(a,t),a=Ka(a,t),o=Za(o),a=Za(a),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`,Ji={texture1:{type:"t",value:new vp().load(yp)},time:{type:"f",value:ur.getElapsedTime()}},Ho=new Zs(500,60,40);Ho.scale(-1,1,1);const Rp=new jt({uniforms:Ji,vertexShader:bp,fragmentShader:wp});js=new wt(Ho,Rp);js.rotation.set(0,-90,0);const Cp=new Pn,Pp=new pp({color:53248}),hr=new wt(Cp,Pp);hr.position.set(5,-5,-5);hr.scale.set(2,2,2);un.add(hr);const Lp=new Pn(100,100,100,4,4,4),Dp=new qs({color:16711935,wireframe:!0}),Up=new wt(Lp,Dp),Ip=document.getElementById("canvas");Ip.remove();Fp();function Np(i){ur.start(),rr=new At(85,window.innerWidth/window.innerHeight,1,1100),zo=new ir(rr),hi=new fp({antialias:!0}),hi.setPixelRatio(window.devicePixelRatio),hi.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(hi.domElement),Go(),un.add(js),un.add(Up)}function Fp(){const i=new ro;i.position.set(1,1,1),un.add(i);const e=new ro;e.position.set(-1,-1,-.5),un.add(e);const t=new Sp;t.intensity=.1,un.add(t)}function Go(){window.requestAnimationFrame(Go),zo.update(),hi.render(un,rr),rr.position.set(Ds,Us,Is),hr.rotation.y+=.0025,Ji.time.value<1?Ji.time.value=ur.getElapsedTime():Ji.time.value=1}window.addEventListener("devicemotion",function(i){Op(i.acceleration)},!0);function Op(i){var e,t="[X, Y, Z]";e=t.replace("X",i.x&&i.x.toFixed(3)),Ds=i.x&&i.x.toFixed(3),e=e.replace("Y",i.y&&i.y.toFixed(3)),Us=i.y&&i.y.toFixed(3),e=e.replace("Z",i.z&&i.z.toFixed(3)),Is=i.z&&i.z.toFixed(3),Tp.innerHTML=Ds+"  "+Us+" "+Is}
